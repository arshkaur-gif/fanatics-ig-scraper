...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%236366f1' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'><rect x='3' y='3' width='18' height='18' rx='5'/><circle cx='12' cy='12' r='4'/><circle cx='17.5' cy='6.5' r='1.2' fill='%236366f1'/></svg>">
...
<body>
  <header class="topbar">
    <div class="topbar-inner">
      <div class="brand">
        ...
        <div class="brand-title">Reach <span id="brandSub">· Social outreach</span></div>
      </div>
    </div>
  </header>
  ...
  <script>
    ...
    function switchTab(tab) {
      ...
      const subs = { ig: '· Social outreach', lb: '· Leaderboard scraper' };
